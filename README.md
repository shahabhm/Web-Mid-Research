...
Jest یک framework بر پایه جاواسکریپت است که توسط فیس‌بوک تولید شده و می‌توان هرگونه برنامه بر پایه جاواسکریپت مانند React و React Native را با آن تست کرد. Jest کار نوشتن تست برای Frontend را بسیار برای توسعه‌دهندگان سریع‌تر و راحت‌‌تر کرده.
